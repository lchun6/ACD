...
if __name__ == '__main__':
    ...
    train, test_train , test_valid ,train_stu_list,test_stu_list = dataSet.get_train_test(dataSet.record, test_ratio=test_ratio)
    train_loader = dataSet.get_data_loader(train, batch_size=batch_size)
    test_loader = dataSet.get_data_loader(test_valid, batch_size=batch_size)
    ...
    model.test(dataSet.all_graph,test_loader)