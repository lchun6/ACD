...
epochs_list = (60, 15, 4, 1,55)
# epochs_list = (60, 15, 4, 1,1)
...
test_data = pd.merge(test_valid.reset_index(), item_data.reset_index(), on="item_id")
...
cdm.train(train, test_data=test , epoch=epochs, lr=0.009, device=device)
